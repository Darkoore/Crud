...
namespace Crud2.Models
{
    public class ExternosBD
    {
        ...
        {
            string constring = ConfigurationManager.ConnectionStrings["LocalBD"].ToString();
            con = new SqlConnection(constring);
        }

        // **************** ADD NEW STUDENT *********************
        public bool AñadirPart(Externos smodel)
        {
            connection();
        ...
        public List<Externos> LeerParticipantes()
        {
            connection();
            List<Externos> participantelist = new List<Externos>();
        ...
        public bool ActualizarPart(Externos smodel)
        {
            connection();
